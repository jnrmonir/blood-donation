<div>
    <form>
        <div class="form-group row">
            <label for="present_country" class="col-sm-4 col-form-label">Permanent Country</label>
             <div class="col-sm-8">
                 <select name="newcountry" class="form-control @error('newcountry') is-invalid  @enderror" wire:model="newcountry" style="width: 100%;">
                     <option>Choose Permanent Country</option>
