<div>
    ...
    @section('title')
    {{ Auth::user()->name }} requested blood
    @endsection
...
<div class="content-header bg-white shadow-sm">
    <div class="container clearfix">
        <h1 class="text-gray text-capitalize float-left" style="font-size: 20px">Your Requested Blood List Below</h1>
          <ol class="breadcrumb float-right">
            <li class="breadcrumb-item"><a href="{{ route('home') }}"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="breadcrumb-item active">Your Requested Blood</li>
          </ol>
    </div><!-- /.container-fluid -->
</div>
<!-- /.content-header -->
                        ...
                        <div class="card  py-2 px-3 rounded-0">
                            ...
                            <div class="d-flex justify-content-between stats pt-1">
                                ...
                                <div class="d-flex flex-row align-items-center">
                                    <span class="text-info" style="cursor: pointer;" ></span>
                                </div>
