...
class SingleBloodDonar extends Component
{
    ...
    public function mount($slug){
        $this->bloodDonar = User::select('id','blood_group_id','name','email','last_seen','phone','profile_photo_path','last_blood_donation','role_id','slug')->with('bloodGroup:id,full_name','profile')->bloodDonar()->where('slug',$slug)->firstOrFail();
    ...
    public function updateRequest()
    {
        ...
        if(DB::table('user_blood_request_to_blood_donar')->where('blood_donar_id',$this->bloodDonar->id)->where('blood_request_id',$this->exist_blood_request_id)->exists()){
            ...
            $exist_blood_request->bloodDonars()->attach($this->bloodDonar->id,['message' => $this->note]);
            $notification = new Notification();
            $notification->user_id = $this->bloodDonar->id;
    ...
    public function submit(){
        ...
        if(Auth::check()){
            ...
            $blood_request->to_user_id = $this->bloodDonar->id;
    ...
    {
        return view('livewire.single-blood-donar')->extends('layouts.app');
    }
}
